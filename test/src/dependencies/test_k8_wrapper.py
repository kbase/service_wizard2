...
@patch("src.dependencies.k8_wrapper.check_service_status_cache")
@patch("src.dependencies.k8_wrapper._get_deployment_status")
def test_query_k8s_deployment_status( mock__get_deployment_status, mock_check_service_status_cache, mock_request,):
    ...
    # ls = label_selector: client.V1LabelSelector
...
@patch("src.dependencies.k8_wrapper.get_k8s_all_service_status_cache")
@patch("src.dependencies.k8_wrapper.get_k8s_app_client")
