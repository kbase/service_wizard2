def test_get_good_status(client_with_authorization):
    ...
    rv = {'git_commit_hash': '64df4dc3c09b225a9468a73e7129f1cf1631ae4e', 'status': 'active', 'version': '0.0.15',
          'hash': '64df4dc3c09b225a9468a73e7129f1cf1631ae4e', 'release_tags': ['beta', 'dev'],
          'url': 'https://ci.kbase.us:443/dynserv/64df4dc3c09b225a9468a73e7129f1cf1631ae4e.StaticNarrative',
          'module_name': 'StaticNarrative', 'health': 'healthy', 'up': 1}

    # sw.start({"module_name": "NarrativeService", "version": "release"})

    rv = {'git_commit_hash': '8a9bb32f9e2ec5169815b984de8e8df550699630', 'status': 'active', 'version': '0.5.2',
